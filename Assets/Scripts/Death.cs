...
{
    public class Death : MovementActionHandler<HitContext>
    {
        public Death(RPGCharacterMovementController movement) : base(movement)
        {
        }
        ...
        protected override void _StartAction(RPGCharacterController controller, HitContext context)
        {
            ...
            controller.Death((KnockdownType)hitNumber);
